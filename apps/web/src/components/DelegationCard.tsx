      ...
      try {
        ...
        if (hasDelegation && code && code.length >= 46) {
          ...
          if (!delegatedToCurrentContract) {
            console.log(
              'Wallet delegated to OLD contract:',
              delegatedTo,
              'Current:',
              currentContract,
            );
    ...
    try {
      ...
      const authorization = {
        ...
        yParity: Number(
          rawAuth.yParity ??
            (rawAuth.v !== undefined
              ? Number(BigInt(rawAuth.v) % 2n === 0n ? 0 : 1)
              : 0),
        ),
      };
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error(
          `Transaction would fail: ${gasError?.message || 'Contract call reverted'}`,
        );
      }
      ...
      <div className="w-full">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-slate-400 max-w-md mx-auto mb-8">
            ProofHeir uses cutting-edge blockchain technology to ensure your
            digital assets are passed on to your chosen heir securely and
            privately.
          </p>
      ...
      <div className="w-full">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-400 text-sm">
            Enable the inheritance smart contract on your wallet using EIP-7702.
          </p>
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-200">
              <strong>What happens:</strong> Your wallet will be enhanced with
              inheritance capabilities. This is a one-time setup that allows the
              claim contract to manage asset transfers.
            </div>
          </div>
        </div>
    ...
    <div className="w-full">
      ...
      {registrationStatus === 'success' ? (
        ...
        <div className="text-center py-8">
          ...
          <h3 className="text-2xl font-bold text-white mb-3">
            Inheritance Plan Complete!
          </h3>
          <p className="text-slate-400 max-w-md mx-auto mb-6">
            Your digital legacy is now protected. Your heir can claim the assets
            using their email and your NUIP.
          </p>
        ...
        <>
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-white mb-2">
              Register Heir Identity
            </h3>
            <p className="text-slate-400 text-sm">
              Enter your heir's information to complete the setup.
            </p>
          </div>
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Your heir will use this email to identify themselves when
                claiming.
              </p>
            </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-amber-200">
                <strong>Important:</strong> Share these details securely with
                your heir. They will need both the email and NUIP to claim the
                inheritance.
              </div>
            </div>
          </div>
  ...
  return (
    <nav aria-label="Progress" className="mb-6 sm:mb-8">
      <ol className="flex items-start justify-between relative px-2 sm:px-0">
        ...
        <div
          className="absolute top-4 sm:top-5 left-6 right-6 sm:left-5 sm:right-5 h-0.5 bg-slate-700"
          aria-hidden="true"
        />
        {/* Progress line fill */}
        <div
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`mt-1.5 sm:mt-2 text-[10px] sm:text-xs font-medium text-center leading-tight max-w-[60px] sm:max-w-none ${
                  index <= currentStep ? 'text-white' : 'text-slate-500'
                }`}
              >
                <span className="sm:hidden" aria-hidden="true">
                  {mobileLabels[step.title] || step.title}
                </span>
                <span className="hidden sm:inline">{step.title}</span>
                <span className="sm:hidden sr-only">{step.title}</span>
              </span>
            </li>
          );
        })}
